    ...
    switch (activeTab) {
      case "tab_1":
        ...
        <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className={`px-4 py-2 rounded-md ${
                  followUpType === 'Call' ? 'bg-theme-red text-white' : 'bg-gray-200 text-gray-700'
              ...
              <button
                ...
                className={`px-4 py-2 rounded-md ${
                  followUpType === 'WhatsApp' ? 'bg-theme-red text-white' : 'bg-gray-200 text-gray-700'
                } hover:bg-theme-red-dark transition-colors duration-200 flex items-center space-x-2`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-md ${
                  followUpType === 'Email' ? 'bg-theme-red text-white' : 'bg-gray-200 text-gray-700'
                } hover:bg-theme-red-dark transition-colors duration-200 flex items-center space-x-2`}
              >
                {followUpType === 'Email' && (
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            <div className="flex items-center space-x-2 cursor-pointer" onClick={handleReminderToggle}>
              ...
              <div className="mt-2 space-y-3 pl-7">
                {reminders.map((reminder, index) => (
                  <div key={index} className="flex space-x-2 items-end">
                    ...
                    <div className="flex-1">
                      <label className="block text-sm font-medium text-gray-700 mb-1">Reminder Follow-up Type</label>
                      <select
                        value={reminder.type}
