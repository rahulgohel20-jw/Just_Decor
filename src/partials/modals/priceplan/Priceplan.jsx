        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center ">
          {plans
            ...
            .map((plan) => (
              <Card
                key={plan.id}
                className={`h-fit min-h-[400px] rounded-2xl hover:shadow-lg transition hover:shadow-[4px_4px_42px_0px_#5243C24B] ${
                  plan.isPopular
                    ? "border-2 border-[#005BA8] min-h-[500px] "
                    : ""
                }`}
              >
                {plan.isPopular && (
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <p className="text-2xl font-bold text-[#170F49]">
                    ...
                    <span className="text-sm font-normal text-[#A0A3BD]">
