...
const Signup = () => {
  ...
  return <div className="card max-w-[400px] w-full">
    <form className="card-body flex flex-col gap-2 p-7" noValidate onSubmit={formik.handleSubmit}>
      <div className="mb-2.5">
        ...
        <span className="text-sm text-gray-600">Please fill in all the information required to create your account on JW.</span>
      </div>
      ...
      <div className="flex flex-col">
        ...
        <label className="input">
          <input placeholder="Email address" type="email" autoComplete="off" {...formik.getFieldProps('email')} className={clsx('form-control bg-transparent', {
      ...
      <div className="flex items-center justify-center font-medium mt-2">
        <span className="text-2sm text-gray-600 me-1.5">Already have on account? </span>
        <Link to={currentLayout?.name === 'auth-branded' ? '/auth/login' : '/auth/classic/login'} className="text-2sm link hover:underline no-underline">
          Sign In
        </Link>
      </div>
    </form>
