...
const EmailTemplateTab = () => {
  const emailTemplate = [
    {
      id: 1,
      template_name: "Template name one",
      subject: "Email Subject one",
      created_by: "Kaushik Brahmbhatt",
      created_by_image: toAbsoluteUrl("/images/user_img.jpg"),
    },
    {
      id: 2,
      template_name: "Template name two",
      subject: "Email Subject two",
      created_by: "Bharat Mer",
      created_by_image: toAbsoluteUrl("/images/user_img.jpg"),
    },
    {
      id: 3,
      template_name: "Template name three",
      subject: "Email Subject three",
      created_by: "Kaushik Brahmbhatt",
      created_by_image: toAbsoluteUrl("/images/user_img.jpg"),
    },
  ];
