    ...
    <div className="grid grid-cols-3 gap-4 text-base">
      <div className="bg-gray-50 rounded-lg p-3">
        <p className="text-gray-500">
          <FormattedMessage id="SETTING.PLAN" defaultMessage="Plan Name" />
        </p>
<p className="font-semibold">{subscriptionData?.plan?.name || "-"}</p>      </div>

      <div className="bg-gray-50 rounded-lg p-3">
        <p className="text-gray-500">
          <FormattedMessage id="SETTING.BILLING" defaultMessage="Billing Cycle" />
        </p>
        <p className="font-semibold">{subscriptionData?.plan?.billingCycle || "-"}</p>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-3">
        ...
        <p className="font-semibold">Rs. {subscriptionData?.plan?.price || 0}.00 /mo</p>
      </div>

      <div className="bg-gray-50 rounded-lg p-3">
  <p className="text-gray-500">
    <FormattedMessage id="SETTING.USERS" defaultMessage="Subscription Status" />
  </p>
  <p className="font-semibold pt-2">
    {subscriptionData?.isActive ? (
      <span className="text-green-600 bg-green-100 px-2 py-1 rounded-md">
        <FormattedMessage id="SETTING.ACTIVE" defaultMessage="Active" />
      </span>
    ) : (
      <span className="text-red-600 bg-red-100 px-2 py-1 rounded-md">
        <FormattedMessage id="SETTING.INACTIVE" defaultMessage="Inactive" />
      </span>
    )}
  </p>
</div>
      ...
      <div className="bg-gray-50 rounded-lg p-3">
        ...
        <p className="font-semibold">{subscriptionData?.startDate || "-"}</p>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-3">
        ...
        <p className="font-semibold">{subscriptionData?.endDate || "-"}</p>
      </div>
    </div>
  </div>
) : (
  <div className="text-center py-10 text-gray-500">No subscription data found.</div>
)}
