      ...
      <Container>
        ...
        <div className="min-h-screen  ">
          ...
          <div className="flex items-center justify-between mb-7">
            ...
            <button className="flex items-center gap-[6px] bg-primary hover:bg-[#1d4ed8] text-white text-sm font-medium px-[14px] py-[7px] rounded-lg shadow-sm">
              <Plus size={16} />
              New Payment
            </button>
          ...
          <div className="flex gap-8 border-b border-[#e5e7eb] mb-7">
            ...
            <button className="text-lg font-medium text-primary pb-3 border-b-2 border-primary">
              Received
            </button>

            <button className="text-lg font-medium text-[#6b7280] pb-3">
              Payable
            </button>
