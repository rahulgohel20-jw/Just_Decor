...
export const defaultData = [
    ...
    {
    link_name: "Home Page",
    description: "The main landing page for the website, providing an overview of services and latest updates.",
    url: "https://www.example.com",
    attachments: ["homepage_banner.png", "logo.svg"]
  },
  {
    link_name: "Donation Page",
    description: "A dedicated page where users can donate money, food, and essential supplies to those in need.",
    url: "https://www.example.com/donate",
    attachments: ["donation_form.pdf", "payment_qr.png"]
  },
  {
    link_name: "About Us",
    description: "Information about the organization, its mission, team members, and community impact.",
    url: "https://www.example.com/about",
    attachments: ["team_photo.jpg", "mission_statement.docx"]
  },
  {
    link_name: "Contact Support",
    description: "Page with a contact form and customer support details for inquiries and assistance.",
    url: "https://www.example.com/contact",
    attachments: ["contact_form_sample.png"]
  },
  {
    link_name: "Membership Benefits",
    description: "Details about the premium membership program and exclusive member offers.",
