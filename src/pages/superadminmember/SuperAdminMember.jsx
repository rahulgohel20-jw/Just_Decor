        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 border border-blue-100">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              ...
              <span className="bg-red-600 text-white text-xs px-3 py-1 rounded-lg shadow-sm flex items-center">
                Not Approved
              </span>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 border border-blue-100">
              ...
              <div>
                ...
                <div className="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
                  ...
                  <button className="bg-primary text-white px-4 py-1.5 rounded-lg text-sm hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md">
                    Download
                  </button>
                </div>
              </div>
