    ...
    <Container>
      <div className="pb-4 mb-3 border-b border-gray-200">
        ...
        <div className="flex justify-end gap-3 mt-3">
          <button
            className="flex items-center gap-2 bg-[#005BA8] text-white px-5 py-2 rounded shadow hover:bg-[#004C8C] transition"
            onClick={() => {
              setIsModalOpen(true);
            }}
          >
      ...
      {/* Dynamic Tab Navigation with Arrows */}
      <div className=" mb-6">
        {/* Tabs Container */}
        <div
          ref={tabContainerRef}
          onScroll={checkScroll}
          className="flex border-b border-gray-200 no-scrollbar"
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {displayedThemes.map((theme, index) => (
              <div
                key={theme.id || index}
                className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200 relative transform transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer"
              >
