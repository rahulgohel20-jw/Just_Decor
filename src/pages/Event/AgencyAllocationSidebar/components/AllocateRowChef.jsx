...
export default function AllocateRowChef({ onAllocate, selectedCount }) {
  ...
  const handleAllocate = () => {
    ...
    if (!selectedVendor && !serviceType && (!pax || pax <= 0)) {
      Swal.fire({
        title: "Missing Information",
        text: "Please fill at least one field (Agency, Service Type, or Pax)",
        icon: "warning",
      });
      return;
    }
    ...
    if (serviceType) {
      allocationData.serviceType = serviceType;
    }
