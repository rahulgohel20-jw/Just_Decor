    ...
    setQuotation((prev) =>
      prev.map((item, i) => {
        if(i === index){
          ...
          let item_total = (Number(newItem.person) + Number(newItem.extra)) * Number(newItem.rate);
              ...
              <div className="flex gap-6 px-4 py-2 bg-blue-50 border-b border-gray-200">
                <div className="text-left flex items-center gap-2">
                  <label className="flex items-center gap-2">
                    <input type="radio" name="amountType" defaultChecked = {form.amount_status === 1}/>
                    Rough Amount
                  </label>
                  <label className="flex items-center gap-2">
                    <input type="radio" name="amountType" value={2} defaultChecked = {form.amount_status === 2}/>
                    Quotation Amount
                  </label>
                </div>
                      ...
                      <tr>
                        ...
                        <td className="border px-2 py-1">
                          <input
                            ...
                            name="date"
                            value={item.date}
                            onChange={(e) => handleInput(index,'date', e.target.value)}
                            className="w-full border px-2 py-1 rounded input"
                          />
                        </td>
                        <td className="border px-2 py-1">
                          <input
                            ...
                            name="person"
                            value={item.person}
                            onChange={(e) => handleInput(index,'person', e.target.value)}
                            className="w-full border px-2 py-1 rounded input"
                          />
                        </td>
                        <td className="border px-2 py-1">
                          <input
                            ...
                            name="extra"
                            value={item.extra}
                            onChange={(e) => handleInput(index,'extra', e.target.value)}
                            className="w-full border px-2 py-1 rounded input"
                          />
                        </td>
                        <td className="border px-2 py-1">
                          <input
                            ...
                            name="rate"
                            value={item.rate}
                            onChange={(e) => handleInput(index,'rate', e.target.value)}
                            className="w-full border px-2 py-1 rounded input"
                          />
                        </td>
                        <td className="border px-2 py-1">
                        ...
                        {index > 0 && (
                          <button className="btn btn-sm btn-icon btn-clear" title="Remove" onClick={() => removequotation(index)}>
