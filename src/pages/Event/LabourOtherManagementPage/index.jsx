...
const handleWhatsAppClick = useCallback(async (row, shift) => {
  try {
    ...
    // Format date from shift
    const dateStr = shift.dateTime
      ? dayjs(shift.dateTime, "DD/MM/YYYY hh:mm A").format("DD.MM.YYYY")
      : "";
      ...
      {data.map((row, index) => {
        ...
        return (
          ...
          >
            ...
            title="WhatsApp"
            onClick={() => onWhatsAppClick(row, shift)}
          >
            <svg
