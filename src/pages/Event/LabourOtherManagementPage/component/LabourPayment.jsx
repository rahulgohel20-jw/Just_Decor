...
const LabourPaymentModal = ({ isOpen, onClose }) => {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100]">
          ...
          <div className="absolute inset-0 pointer-events-none flex items-start justify-end p-3 sm:p-6">
            ...
            >
              {/* Header */}
              <div className="flex items-center gap-3 px-4 sm:px-8 py-4 sm:py-6 border-b border-gray-200">
              ...
              <div className="flex-1 overflow-y-auto px-4 sm:px-8 py-4 sm:py-6">
                ...
                {/* Date & Shift, Total Qty, Pending Amount */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                  <div>
                    <label className="block text-sm font-medium text-gray-600 mb-1.5">
                     Start & End Date
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-gray-900">04/02/2024</span>
                      -
                      <span className="text-sm text-gray-900">05/02/2024</span>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-base font-medium text-gray-900">20</div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          onChange={(e) =>
                            setFormData({ ...formData, depositTo: e.target.value })
                          }
                          className="w-full px-4 py-2.5 pr-10 border border-gray-300 rounded-lg text-sm text-gray-900 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                        >
...
export default LabourPaymentModal;