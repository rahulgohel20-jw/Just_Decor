...
import LabourPaymentModal from "./LabourPayment";
const AllLabour = ({ isOpen, onClose }) => {
          ...
          <div className="absolute inset-0 pointer-events-none flex items-start justify-end p-3 sm:p-6">
           ...
           {/* Header */}
            ...
            <p className="text-sm text-gray-500">
                Manage and track all outstanding labour payments.
            </p>
            </div>
            ...
            <div className="bg-white border rounded-xl shadow-sm overflow-hidden">
                ...
                <table className="w-full text-sm">
                    ...
                    <tr>
                        <th className="px-4 py-3 text-left">Labour Category</th>
